...
if (PUBLIC_ONLY) {
    ...
    app.put('/api/theme', (req, res) => {
        const { primary, gradientStart, gradientEnd, fontFamily, applyToAll, currentDatasetId } = req.body || {};
        ...
        try {
            const writeAll = db.transaction(() => {
                ...
                const themeBlob = { primary, gradientStart: gradientStart || null, gradientEnd: gradientEnd || null, fontFamily: font };
