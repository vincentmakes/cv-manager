...
function gatherCvData(options = {}) {
    ...
    sections.forEach(s => {
        ...
        sectionOrderData.push({ key: s.section_name, sort_order: s.sort_order || 0, visible: !!s.visible, print_visible: s.print_visible !== 0, print_compact: s.print_compact === 1, display_name: s.display_name || null, name: resolved, default_name: defaultName });
    });
...
function propagateStructure(sourceId) {
    try {
        ...
        const srcSectionOrder = (srcData.sectionOrder || []).map(s => ({
            key: s.key, sort_order: s.sort_order, visible: s.visible, print_visible: s.print_visible, print_compact: s.print_compact
        }));
            ...
            for (const sibling of siblings) {
                ...
                sibData.sectionOrder = srcSectionOrder.map(s => {
                    ...
                    return {
                        ...
                        visible: s.visible,
                        print_visible: s.print_visible,
                        print_compact: s.print_compact,
