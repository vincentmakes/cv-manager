...
| Option | Wirkung |
|--------|---------|
| **Indexieren, Folgen** | Lebenslauf erscheint in Suchergebnissen, Suchmaschinen folgen Ihren Links (Standard) |
| **Nicht indexieren, Folgen** | Lebenslauf wird in Suchergebnissen ausgeblendet, aber Links werden verfolgt |
| **Indexieren, Nicht folgen** | Lebenslauf erscheint in Suchergebnissen, aber ausgehende Links werden ignoriert |
| **Nicht indexieren, Nicht folgen** | Vollständig unsichtbar für Suchmaschinen |
